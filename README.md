...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ijaun2y.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ijaun2y.containers.anotherwebservice.com/
...
```
git clone git@github.com:alvii147/piston.git
cd container-ijaun2y
```
...
```
docker attach container-ijaun2y
```
